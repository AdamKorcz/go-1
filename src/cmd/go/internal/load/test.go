...
func TestPackagesFor(ctx context.Context, opts PackageOpts, p *Package, cover *TestCover, libFuzzerMode bool) (pmain, ptest, pxtest *Package, err error) {
	pmain, ptest, pxtest = TestPackagesAndErrors(ctx, opts, p, cover, libFuzzerMode)
...
func TestPackagesAndErrors(ctx context.Context, opts PackageOpts, p *Package, cover *TestCover, libFuzzerMode bool) (pmain, ptest, pxtest *Package) {
	...
	if opts.ForceCgo {
		allImports = append(allImports, "C")
	}
...
func FmtTestMainLibFuzzer() ([]byte, error) {
	var buf bytes.Buffer
	tmpl := testmainTmplLibFuzzer2
...
// formatTestmain returns the content of the _testmain.go file for t.
func formatTestmainLibfuzzer(t *testFuncs) ([]byte, error) {
	var buf bytes.Buffer
	tmpl := testmainTmplLibFuzzer
	if err := tmpl.Execute(&buf, t); err != nil {
		return nil, err
	}
	return buf.Bytes(), nil
...
var testmainTmplLibFuzzer = lazytemplate.New("main", `
...
var testmainTmplLibFuzzer2 = lazytemplate.New("main", `
	// Code generated by go-118-fuzz-build; DO NOT EDIT.
// +build ignore
package main
import (
